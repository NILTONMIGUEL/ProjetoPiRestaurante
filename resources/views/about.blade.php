     ...
     <section id="home" class="hero">
        ...
        <section id="menu" class="section menu-section">
            ...
            <div class="carousel-container">
                <div class="carousel-track" id="carousel-track">
                    ...
                    <div class="menu-card" id="menu-card">
                        <img src=".jpg" alt="Sobremesa Tiramisu">
                        <h3>teste1 Cremoso</h3>
                        <p>Clássica sobremesa italiana com um toque especial.</p>
                        <span class="price">R$ 35,00</span>
                    </div>
                    <div class="menu-card" id="menu-card">
                        <img src=".jpg" alt="Sobremesa Tiramisu">
                        <h3>teste2 Cremoso</h3>
                        <p>Clássica sobremesa italiana com um toque especial.</p>
                        <span class="price">R$ 35,00</span>
                    </div>
                    <div class="menu-card" id="menu-card">
                        <img src=".jpg" alt="Sobremesa Tiramisu">
                        <h3>teste3 Cremoso</h3>
                        <p>Clássica sobremesa italiana com um toque especial.</p>
                        <span class="price">R$ 35,00</span>
                    </div>
                </div>
        ...
        <section id="galeria" class="section galeria-section">
            ...
            <div class="galeria-grid">
                ...
                <div class="galeria-item"><img src="" alt="Mesa posta elegante"></div>
                ...
                <div class="galeria-item"><img src="" alt="Vista Externa"></div>
                <div class="galeria-item"><img src="" alt="Detalhe da decoração"></div>
            </div>
        </section>
